...
<main class="wrap">
  <section class="hero" style="padding-top: 24px;">
    <div class="section-header">
      ...
      <a class="button-ghost" href="<?php echo esc_url(home_url('/')); ?>">See categories</a>
    </div>
    <div class="hero-grid">
      ...
      <div class="hero-visual">
        <div class="panel">
          <img src="<?php echo $media_base; ?>/contact-about-info-grahic.jpg" alt="Contact and about info graphic">
          <div class="chips">
